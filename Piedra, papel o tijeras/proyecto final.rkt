...
;-----------------------------------------------------------------------------------------------------------------
;ventanas de trancicion definidas como funcion para llamrlas cuando re requieran 
(define (j)
...
(define (emp3)
  (define emp3ventana(open-viewport "Empate3" 700 600))
  ((draw-pixmap emp3ventana) "empate3.png" (make-posn 0 0))
  (sleep 3)
  (close-viewport emp3ventana)
  )
(define (demp12)
...
;------------------------------------------------------------
; se crean los vectores para utilizarlos en las funciones
(define vecj1 (make-vector 1))
(define vecj2 (make-vector 1))
(define vecj3 (make-vector 1))
;las funciones comparan caracteres para decidir quien gana
; piedra #\r} papel #\p} tijeras #\t}   
...
;-------------------------------------------------
;funcion para definir el ganador en la ventana 3p { 3 jugadores}
(define(ganador3p vecj1 vecj2 vecj3)
  (cond
    ((and(char=? (vector-ref vecj1 0) #\r)(char=? (vector-ref vecj2 0) #\t)(char=? (vector-ref vecj3 0) #\t))
    (begin
      (gj1)
      (ventana3p)))
    ((and(char=? (vector-ref vecj1 0) #\t)(char=? (vector-ref vecj2 0) #\p)(char=? (vector-ref vecj3 0) #\p))
    (begin
      (gj1)
      (ventana3p)))
    ((and(char=? (vector-ref vecj1 0) #\p)(char=? (vector-ref vecj2 0) #\r)(char=? (vector-ref vecj3 0) #\r))
    (begin
      (gj1)
      (ventana3p)))
    ((and(char=? (vector-ref vecj1 0) #\t)(char=? (vector-ref vecj2 0) #\r)(char=? (vector-ref vecj3 0) #\t))
    (begin
      (gj2)
      (ventana3p)))
    ((and(char=? (vector-ref vecj1 0) #\p)(char=? (vector-ref vecj2 0) #\t)(char=? (vector-ref vecj3 0) #\p))
    (begin
      (gj2)
      (ventana3p)))
    ((and(char=? (vector-ref vecj1 0) #\r)(char=? (vector-ref vecj2 0) #\p)(char=? (vector-ref vecj3 0) #\r))
    (begin
      (gj2)
      (ventana3p)))
    ((and(char=? (vector-ref vecj1 0) #\t)(char=? (vector-ref vecj2 0) #\t)(char=? (vector-ref vecj3 0) #\r))
    (begin
      (gj3)
      (ventana3p)))
    ((and(char=? (vector-ref vecj1 0) #\p)(char=? (vector-ref vecj2 0) #\p)(char=? (vector-ref vecj3 0) #\t))
    (begin
      (gj3)
      (ventana3p)))
    ((and(char=? (vector-ref vecj1 0) #\r)(char=? (vector-ref vecj2 0) #\r)(char=? (vector-ref vecj3 0) #\p))
    (begin
      (gj3)
      (ventana3p)))
    ((and(char=? (vector-ref vecj1 0) #\r)(char=? (vector-ref vecj2 0) #\p)(char=? (vector-ref vecj3 0) #\t))
    (begin
      (emp3)
      (ventana3p)))
    ((and(char=? (vector-ref vecj1 0) #\r)(char=? (vector-ref vecj2 0) #\t)(char=? (vector-ref vecj3 0) #\p))
    (begin
      (emp3)
      (ventana3p)))
    ((and(char=? (vector-ref vecj1 0) #\t)(char=? (vector-ref vecj2 0) #\p)(char=? (vector-ref vecj3 0) #\r))
    (begin
      (emp3)
      (ventana3p)))
    ((and(char=? (vector-ref vecj1 0) #\t)(char=? (vector-ref vecj2 0) #\r)(char=? (vector-ref vecj3 0) #\p))
    (begin
      (emp3)
      (ventana3p)))
    ((and(char=? (vector-ref vecj1 0) #\p)(char=? (vector-ref vecj2 0) #\r)(char=? (vector-ref vecj3 0) #\t))
    (begin
      (emp3)
      (ventana3p)))
    ((and(char=? (vector-ref vecj1 0) #\p)(char=? (vector-ref vecj2 0) #\t)(char=? (vector-ref vecj3 0) #\r))
    (begin
      (emp3)
      (ventana3p)))
    ((and(char=? (vector-ref vecj1 0) #\p)(char=? (vector-ref vecj2 0) #\p)(char=? (vector-ref vecj3 0) #\p))
    (begin
      (emp3)
      (ventana3p)))
    ((and(char=? (vector-ref vecj1 0) #\t)(char=? (vector-ref vecj2 0) #\t)(char=? (vector-ref vecj3 0) #\t))
    (begin
      (emp3)
      (ventana3p)))
    ((and(char=? (vector-ref vecj1 0) #\r)(char=? (vector-ref vecj2 0) #\r)(char=? (vector-ref vecj3 0) #\r))
    (begin
      (emp3)
      (ventana3p)))
    ((and(char=? (vector-ref vecj1 0) #\p)(char=? (vector-ref vecj2 0) #\p)(char=? (vector-ref vecj3 0) #\r))
    (begin
      (demp12)
      (ventanapvp)))
    ((and(char=? (vector-ref vecj1 0) #\t)(char=? (vector-ref vecj2 0) #\t)(char=? (vector-ref vecj3 0) #\p))
    (begin
      (demp12)
      (ventanapvp)))
    ((and(char=? (vector-ref vecj1 0) #\r)(char=? (vector-ref vecj2 0) #\r)(char=? (vector-ref vecj3 0) #\t))
    (begin
      (demp12)
      (ventanapvp)))
    ((and(char=? (vector-ref vecj1 0) #\p)(char=? (vector-ref vecj2 0) #\r)(char=? (vector-ref vecj3 0) #\p))
    (begin
      (demp13)
      (ventanapvp)))
    ((and(char=? (vector-ref vecj1 0) #\t)(char=? (vector-ref vecj2 0) #\p)(char=? (vector-ref vecj3 0) #\t))
    (begin
      (demp13)
      (ventanapvp)))
    ((and(char=? (vector-ref vecj1 0) #\r)(char=? (vector-ref vecj2 0) #\t)(char=? (vector-ref vecj3 0) #\r))
    (begin
      (demp13)
      (ventanapvp)))
    ((and(char=? (vector-ref vecj1 0) #\r)(char=? (vector-ref vecj2 0) #\p)(char=? (vector-ref vecj3 0) #\p))
    (begin
      (demp23)
      (ventanapvp)))
    ((and(char=? (vector-ref vecj1 0) #\p)(char=? (vector-ref vecj2 0) #\t)(char=? (vector-ref vecj3 0) #\t))
    (begin
      (demp23)
      (ventanapvp)))
    ((and(char=? (vector-ref vecj1 0) #\t)(char=? (vector-ref vecj2 0) #\r)(char=? (vector-ref vecj3 0) #\r))
    (begin
      (demp23)
      (ventanapvp)))
...
;------------------------------------------------------------------------------------------------
;define la funcion ventana3p { 3 jugadores}
(define (ventana3p)
  ;devine la ventana para operar con el mouse en ella 
